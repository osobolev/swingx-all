...
public class UIManagerExt {
     ...
     *
     * @param key an {@code Object} specifying the integer
     * @return the {@code int}
     * @throws NullPointerException if {@code key} is {@code null}
     */
     ...
     *
     * @param key an {@code Object} specifying the integer
     * @param l   the {@code Locale} for which the integer is desired; refer
     *            to {@code UIDefaults} for details on how a {@code null}
     *            {@code Locale} is handled
     * @return the {@code int}
     * @throws NullPointerException if {@code key} is {@code null}
     ...
     *
     * @param key an {@code Object} specifying the Boolean
...
//    }
     ...
     *
     * @param key an {@code Object} specifying the shape
     * @param l   the {@code Locale} for which the shape is desired; refer
     *            to {@code UIDefaults} for details on how a {@code null}
     *            {@code Locale} is handled
     * @return the {@code Shape} object
     * @throws NullPointerException if {@code key} is {@code null}
     ...
     *
     * @param key an {@code Object} specifying the painter
     ...
     *
     * @param key an {@code Object} specifying the painter
     * @param l   the {@code Locale} for which the painter is desired; refer
     *            to {@code UIDefaults} for details on how a {@code null}
     *            {@code Locale} is handled
     * @return the {@code Painter} object
     * @throws NullPointerException if {@code key} is {@code null}
     ...
     * @param defaultBorder the border to return if the border specified by
     *                      {@code key} does not exist
     * @return the {@code Border} object
     * @throws NullPointerException if {@code key} or {@code defaultBorder} is {@code null}
     */
     ...
     *
     * @param key          an {@code Object} specifying the color
     * @param defaultColor the color to return if the color specified by {@code key}
     *                     does not exist
     * @return the {@code Color} object
     * @throws NullPointerException if {@code key} or {@code defaultColor} is {@code null}
     */
     ...
     *
     * @param key              an {@code Object} specifying the dimension
     * @param defaultDimension the dimension to return if the dimension specified by
     *                         {@code key} does not exist
     ...
     * @param defaultIcon the icon to return if the icon specified by {@code key}
     *                    does not exist
     * @return the {@code Icon} object
     * @throws NullPointerException if {@code key} or {@code defaultIcon} is {@code null}
     */
     ...
     *
     * @param key           an {@code Object} specifying the insets
     * @param defaultInsets the insets to return if the insets specified by
     *                      {@code key} does not exist
     * @return the {@code Insets} object
     * @throws NullPointerException if {@code key} or {@code defaultInsets} is {@code null}
     */
