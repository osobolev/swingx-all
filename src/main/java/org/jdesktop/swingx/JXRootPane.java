/*
 * $Id: JXRootPane.java 4147 2012-02-01 17:13:24Z kschaefe $
 *
...
public class JXRootPane extends JRootPane {
    ...
    protected class XRootLayout extends RootLayout {
         ...
         *
         * @param delegate the backing manager
         */
...
//            int h = b.height - i.top - i.bottom;
     ...
     * @beaninfo description: The button activated by default for cancel actions in this root pane
     * @see #getCancelButton()
     */
