...
public class ListComboBoxModel<E> extends AbstractListModel<E> implements ComboBoxModel<E>, ActionListener {
     ...
     *
     * @param list the list backing this model
     ...
     *
     * @param item the list object to select or {@code null} to clear the
     *             selection
     * @throws ClassCastException if {@code item} is not of type {@code E}
     */
    @Override
