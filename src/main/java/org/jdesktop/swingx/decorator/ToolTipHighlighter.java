...
public class ToolTipHighlighter extends AbstractHighlighter {
     ...
     * always.
     *
     * @param toolTipValue the StringValue used to create the tool tip
     */
     ...
     *
     * @param toolTipValue the StringValue used for decoration, may be null to use default decoration.
     * @see #getToolTipValue()
     */
