...
public class IconBorder implements Border, Serializable {
     ...
     *
     * @param validIcon the icon to set. This may be {@code null} to represent an
     *                  empty icon.
     * @see #EMPTY_ICON
     */
     ...
     * @param validIcon    the icon to set. This may be {@code null} to represent an
     *                     empty icon.
     * @param iconPosition the position to place the icon relative to the component
     ...
     *                     <li>{@code WEST}</li>
     *                     </ul>
     * @throws IllegalArgumentException if {@code iconPosition} is not a valid position.
     * @see #EMPTY_ICON
     */
     ...
     *                     <li>{@code WEST}</li>
     *                     </ul>
     * @param padding      the padding to surround the icon with. All non-positive values
     ...
     *
     * @param padding the padding to set. If {@code padding < 0}, then
