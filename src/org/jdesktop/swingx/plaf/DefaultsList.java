...
public final class DefaultsList {
     ...
     * {@code true}.
     *
     * @param key   the key that will be used to query {@code UIDefaults}
     * @param value the value associated with the key
     * @throws NullPointerException     if {@code key} is {@code null}
     * @throws IllegalArgumentException if {@code value} is a type that should be a
     ...
     * @param key            the key that will be used to query {@code UIDefaults}
     * @param value          the value associated with the key
     * @param enableChecking if {@code true} then the value is checked to ensure that
